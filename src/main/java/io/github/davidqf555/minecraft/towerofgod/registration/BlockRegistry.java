...
public final class BlockRegistry {
    ...
    public static final RegistryObject<DropExperienceBlock> SUSPENDIUM_ORE = register("suspendium_ore", () -> new DropExperienceBlock(Block.Properties.of(Material.STONE).strength(5f, 5f).requiresCorrectToolForDrops()));
