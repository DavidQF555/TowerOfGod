...
public class ServerUpdateAttributePacket {
    ...
    private static final BiConsumer<ServerUpdateAttributePacket, PacketBuffer> ENCODER = (message, buffer) -> {
    ...
    private static final Function<PacketBuffer, ServerUpdateAttributePacket> DECODER = buffer -> new ServerUpdateAttributePacket(buffer.readInt(), buffer.readBoolean() ? null : ShinsuAttributeRegistry.getRegistry().getValue(buffer.readResourceLocation()));
