    ...
    private static class FindRegularTeamGoal extends Goal {
        ...
        public void start() {
            ...
            if (team != null) {
                ...
                AxisAlignedBB bounds = AxisAlignedBB.ofSize(range * 2, range * 2, range * 2).move(entity.position());
    ...
    private static class RegularHurtByTargetGoal extends HurtByTargetGoal {
        ...
        protected void alertOthers() {
            ...
            if (revenge != null) {
                ...
                AxisAlignedBB bounds = AxisAlignedBB.ofSize(range * 2, 10, range * 2).move(mob.position());
