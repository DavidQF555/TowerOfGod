...
public class ShinsuArrowEntity extends AbstractArrow {
    ...
    private BlockHitResult latestHit;
    ...
    public void onRemovedFromWorld() {
        if (level instanceof ServerLevel) {
            ...
            if (attribute != null) {
                ...
                attribute.applyBlockEffect(this, latestHit == null || hasImpulse ? new BlockHitResult(motion, Direction.getNearest(motion.x, motion.y, motion.z), blockPosition(), true) : latestHit);
            }
        }
