...
public final class Messages {
    ...
    public static Component getRequiresBaangs(int requirement) {
        return Component.translatable("technique." + TowerOfGod.MOD_ID + ".error.requires_baangs", requirement);
    }

    public static Component getRequiresLevel(ShinsuTechniqueType type, int requirement) {
        return Component.translatable("technique." + TowerOfGod.MOD_ID + ".error.requires_level", requirement, type.getText());
    }
