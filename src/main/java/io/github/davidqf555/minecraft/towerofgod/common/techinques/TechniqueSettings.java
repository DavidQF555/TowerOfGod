...
public class TechniqueSettings {
    ...
    private final Map<String, Pair<ITextComponent, IRenderData>> options;
    private final String def;

    public TechniqueSettings(ITextComponent title, Map<String, Pair<ITextComponent, IRenderData>> options, String def) {
        this.title = title;
    ...
    public IRenderData getIcon(String option) {
