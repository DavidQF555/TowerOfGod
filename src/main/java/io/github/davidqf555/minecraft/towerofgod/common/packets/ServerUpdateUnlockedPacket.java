...
public class ServerUpdateUnlockedPacket {
    ...
    private static final BiConsumer<ServerUpdateUnlockedPacket, PacketBuffer> ENCODER = (message, buffer) -> {
    ...
    private static final Function<PacketBuffer, ServerUpdateUnlockedPacket> DECODER = buffer -> {
