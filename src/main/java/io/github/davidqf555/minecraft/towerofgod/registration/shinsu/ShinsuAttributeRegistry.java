...
public final class ShinsuAttributeRegistry {
    ...
    public static final RegistryObject<ShinsuAttribute> WIND = register("wind", () -> new ShinsuAttribute(ParticleTypes.AMBIENT_ENTITY_EFFECT, DamageSource.CRAMMING, 1.4, 1, 0xAAabffac, new KnockbackAttributeEffect(1), new PushAttributeEffect<>(5, dist -> 3 / (dist + 1)), DropsFilter.NONE, new StatSuitabilityCalculator(Stats.CUSTOM.get(Stats.AVIATE_ONE_CM)).scale(0.1)));
