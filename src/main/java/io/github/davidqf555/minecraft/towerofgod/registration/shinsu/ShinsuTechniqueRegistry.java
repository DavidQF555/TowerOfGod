...
public final class ShinsuTechniqueRegistry {
    ...
    public static final RegistryObject<OverridingShinsuTechnique> BLACK_FISH = register("black_fish", () -> new OverridingShinsuTechnique(false, new BlackFish.Factory(), ShinsuIcons.SWIRL, new IRequirement[]{new TypeLevelRequirement(ShinsuTechniqueType.CONTROL, 5)}, ImmutableList.of(Direction.UP, Direction.DOWN, Direction.DOWN), MobUseCondition.and(new GearCondition(EquipmentSlot.HEAD, ItemStack::isEmpty), new GearCondition(EquipmentSlot.CHEST, ItemStack::isEmpty), new GearCondition(EquipmentSlot.LEGS, ItemStack::isEmpty), new GearCondition(EquipmentSlot.FEET, ItemStack::isEmpty))));
    public static final RegistryObject<ShinsuTechnique> SHINSU_BLAST = register("shinsu_blast", () -> new ShinsuTechnique(false, new ShinsuBlast.Factory(), ShinsuIcons.BAANGS, new IRequirement[]{new TypeLevelRequirement(ShinsuTechniqueType.CONTROL, 2), new AttributeRequirement(() -> null)}, ImmutableList.of(Direction.DOWN, Direction.UP), TargetDistanceCondition.above(8)));
    public static final RegistryObject<ShinsuTechnique> FLARE_WAVE_EXPLOSION = register("flare_wave_explosion", () -> new ShinsuTechnique(false, new FlareWaveExplosion.Factory(), ShinsuIcons.TENSION, new IRequirement[]{new TypeLevelRequirement(ShinsuTechniqueType.DISRUPTION, 10)}, ImmutableList.of(Direction.UP, Direction.DOWN, Direction.UP), TargetDistanceCondition.below(4)));
    public static final RegistryObject<ShinsuTechnique> REVERSE_FLOW_CONTROL = register("reverse_flow_control", () -> new ShinsuTechnique(false, new ReverseFlowControl.Factory(), ShinsuIcons.REVERSE, new IRequirement[]{new TypeLevelRequirement(ShinsuTechniqueType.DISRUPTION, 15)}, ImmutableList.of(Direction.UP, Direction.RIGHT, Direction.RIGHT), TargetDistanceCondition.below(4)));
