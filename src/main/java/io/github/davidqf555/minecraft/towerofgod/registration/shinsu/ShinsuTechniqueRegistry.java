...
public final class ShinsuTechniqueRegistry {
    ...
    public static final RegistryObject<OverridingShinsuTechnique> BLACK_FISH = register("black_fish", () -> new OverridingShinsuTechnique(false, new BlackFish.Factory(), ShinsuIcons.SWIRL, new IRequirement[]{}, ShinsuTechnique.UsageData.all(ImmutableList.of(Direction.UP, Direction.DOWN, Direction.DOWN)), MobUseCondition.and(new GearCondition(EquipmentSlotType.HEAD, ItemStack::isEmpty), new GearCondition(EquipmentSlotType.CHEST, ItemStack::isEmpty), new GearCondition(EquipmentSlotType.LEGS, ItemStack::isEmpty), new GearCondition(EquipmentSlotType.FEET, ItemStack::isEmpty))));
    ...
    public static final RegistryObject<ShinsuTechnique> CHANNEL_LIGHTNING = register("channel_lightning", () -> new ShinsuTechnique(true, new ChannelLightning.Factory(), ShinsuIcons.LIGHTNING, new IRequirement[]{new AttributeRequirement(ShinsuAttributeRegistry.LIGHTNING.get())}, new ShinsuTechnique.UsageData(ImmutableList.of(Direction.DOWN, Direction.UP), ImmutableList.of(ShinsuAttributeRegistry.LIGHTNING.get()), new ArrayList<>(ShinsuShapeRegistry.getRegistry().getValues()), ImmutableList.of(GroupRegistry.KHUN.get())), TargetDistanceCondition.above(8)));
    public static final RegistryObject<ShinsuTechnique> FLASH = register("flash", () -> new ShinsuTechnique(false, new Flash.Factory(), ShinsuIcons.FLASH, new IRequirement[]{new AttributeRequirement(ShinsuAttributeRegistry.LIGHTNING.get())}, new ShinsuTechnique.UsageData(ImmutableList.of(Direction.UP, Direction.RIGHT, Direction.DOWN, Direction.LEFT), ImmutableList.of(ShinsuAttributeRegistry.LIGHTNING.get()), new ArrayList<>(ShinsuShapeRegistry.getRegistry().getValues()), ImmutableList.of(GroupRegistry.KHUN.get())), TargetDistanceCondition.above(8)));
    public static final RegistryObject<ShinsuTechnique> BOOST = register("boost", () -> new ShinsuTechnique(false, new Boost.Factory(), ShinsuIcons.SHINSU, new IRequirement[]{new AttributeRequirement(ShinsuAttributeRegistry.FIRE.get())}, new ShinsuTechnique.UsageData(ImmutableList.of(Direction.UP, Direction.RIGHT, Direction.DOWN, Direction.LEFT), ImmutableList.of(ShinsuAttributeRegistry.FIRE.get()), new ArrayList<>(ShinsuShapeRegistry.getRegistry().getValues()), ImmutableList.of(GroupRegistry.YEON.get())), TargetDistanceCondition.above(8)));
    public static final RegistryObject<OverridingShinsuTechnique> FLAMETHROWER = register("flamethrower", () -> new OverridingShinsuTechnique(false, new Flamethrower.Factory(), ShinsuIcons.SHINSU, new IRequirement[]{new AttributeRequirement(ShinsuAttributeRegistry.FIRE.get())}, new ShinsuTechnique.UsageData(ImmutableList.of(Direction.DOWN, Direction.UP), ImmutableList.of(ShinsuAttributeRegistry.FIRE.get()), new ArrayList<>(ShinsuShapeRegistry.getRegistry().getValues()), ImmutableList.of(GroupRegistry.YEON.get())), new HasTargetCondition(true)));
    ...
    public static final RegistryObject<OverridingShinsuTechnique> THUNDERSTORM = register("thunderstorm", () -> new OverridingShinsuTechnique(false, new Thunderstorm.Factory(), ShinsuIcons.SHINSU, new IRequirement[]{new AttributeRequirement(ShinsuAttributeRegistry.LIGHTNING.get())}, new ShinsuTechnique.UsageData(ImmutableList.of(Direction.DOWN, Direction.LEFT, Direction.UP), ImmutableList.of(ShinsuAttributeRegistry.LIGHTNING.get()), new ArrayList<>(ShinsuShapeRegistry.getRegistry().getValues()), ImmutableList.of(GroupRegistry.KHUN.get())), new HasTargetCondition(true)));
