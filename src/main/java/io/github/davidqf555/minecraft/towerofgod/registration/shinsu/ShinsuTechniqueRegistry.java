...
public final class ShinsuTechniqueRegistry {
    ...
    public static final RegistryObject<OverridingShinsuTechnique> BODY_REINFORCEMENT = register("body_reinforcement", () -> new OverridingShinsuTechnique(false, new BodyReinforcement.Factory(), ShinsuIcons.RESISTANCE, new IRequirement[]{}, ImmutableList.of(Direction.UP, Direction.UP, Direction.UP), MobUseCondition.TRUE));
    public static final RegistryObject<OverridingShinsuTechnique> BLACK_FISH = register("black_fish", () -> new OverridingShinsuTechnique(false, new BlackFish.Factory(), ShinsuIcons.SWIRL, new IRequirement[]{}, ImmutableList.of(Direction.UP, Direction.DOWN, Direction.DOWN), MobUseCondition.and(new GearCondition(EquipmentSlotType.HEAD, ItemStack::isEmpty), new GearCondition(EquipmentSlotType.CHEST, ItemStack::isEmpty), new GearCondition(EquipmentSlotType.LEGS, ItemStack::isEmpty), new GearCondition(EquipmentSlotType.FEET, ItemStack::isEmpty))));
    public static final RegistryObject<ShinsuTechnique> SHINSU_BLAST = register("shinsu_blast", () -> new ShinsuTechnique(false, new ShinsuBlast.Factory(), ShinsuIcons.BAANGS, new IRequirement[]{new AttributeRequirement(null)}, ImmutableList.of(Direction.DOWN, Direction.UP), TargetDistanceCondition.above(8)));
    public static final RegistryObject<ShinsuTechnique> FLARE_WAVE_EXPLOSION = register("flare_wave_explosion", () -> new ShinsuTechnique(false, new FlareWaveExplosion.Factory(), ShinsuIcons.TENSION, new IRequirement[]{}, ImmutableList.of(Direction.UP, Direction.DOWN, Direction.UP), TargetDistanceCondition.below(4)));
    public static final RegistryObject<ShinsuTechnique> REVERSE_FLOW_CONTROL = register("reverse_flow_control", () -> new ShinsuTechnique(false, new ReverseFlowControl.Factory(), ShinsuIcons.REVERSE, new IRequirement[]{}, ImmutableList.of(Direction.UP, Direction.RIGHT, Direction.RIGHT), TargetDistanceCondition.below(4)));
    public static final RegistryObject<OverridingShinsuTechnique> MANIFEST = register("manifest", () -> new OverridingShinsuTechnique(true, new Manifest.Factory(), ShinsuIcons.PICKAXE, new IRequirement[]{new ShapeRequirement()}, ImmutableList.of(Direction.LEFT, Direction.RIGHT), MobUseCondition.TRUE));
    ...
    public static final RegistryObject<ShinsuTechnique> MOVE_DEVICES = register("move_devices", () -> new ShinsuTechnique(true, new MoveDevices.Factory(), ShinsuIcons.MOVE, new IRequirement[]{}, ImmutableList.of(Direction.UP, Direction.RIGHT, Direction.LEFT), MobUseCondition.TRUE));
    public static final RegistryObject<OverridingShinsuTechnique> LIGHTHOUSE_FLOW_CONTROL = register("lighthouse_flow_control", () -> new OverridingShinsuTechnique(true, new LighthouseFlowControl.Factory(), ShinsuIcons.LIGHTHOUSE_FLOW_CONTROL, new IRequirement[]{}, ImmutableList.of(Direction.UP, Direction.RIGHT, Direction.UP, Direction.LEFT), MobUseCondition.TRUE));
    public static final RegistryObject<ShinsuTechnique> SCOUT = register("scout", () -> new ShinsuTechnique(false, new Scout.Factory(), ShinsuIcons.EYE, new IRequirement[]{}, ImmutableList.of(Direction.UP, Direction.DOWN, Direction.RIGHT, Direction.LEFT), MobUseCondition.TRUE));
    public static final RegistryObject<ToggleableShinsuTechnique> FOLLOW_OWNER = register("follow_owner", () -> new ToggleableShinsuTechnique(true, new FollowOwner.Factory(), ShinsuIcons.FOLLOW, new IRequirement[]{}, ImmutableList.of(Direction.UP, Direction.LEFT), MobUseCondition.TRUE));
