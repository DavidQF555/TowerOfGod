...
public final class ShinsuTechniqueRegistry {
    ...
    public static final RegistryObject<ShinsuTechnique> SHINSU_BLAST = register("shinsu_blast", () -> new ShinsuTechnique(false, new ShinsuBlast.Factory(), ShinsuIcons.BAANGS, new IRequirement[]{new TypeLevelRequirement(ShinsuTechniqueType.CONTROL, 2), new QualityRequirement(null)}, ImmutableList.of(Direction.DOWN, Direction.UP)));
    public static final RegistryObject<ShinsuTechnique> FLARE_WAVE_EXPLOSION = register("flare_wave_explosion", () -> new ShinsuTechnique(false, new FlareWaveExplosion.Factory(), ShinsuIcons.TENSION, new IRequirement[]{new TypeLevelRequirement(ShinsuTechniqueType.DISRUPTION, 10)}, ImmutableList.of(Direction.UP, Direction.DOWN, Direction.UP)));
    public static final RegistryObject<ShinsuTechnique> REVERSE_FLOW_CONTROL = register("reverse_flow_control", () -> new ShinsuTechnique(false, new ReverseFlowControl.Factory(), ShinsuIcons.REVERSE, new IRequirement[]{new TypeLevelRequirement(ShinsuTechniqueType.DISRUPTION, 15)}, ImmutableList.of(Direction.UP, Direction.RIGHT, Direction.RIGHT)));
    ...
    public static final RegistryObject<ShinsuTechnique> SHOOT_SHINSU_ARROW = register("shoot_shinsu_arrow", () -> new ShinsuTechnique(false, new ShootShinsuArrow.Factory(), ShinsuIcons.BAANGS, new IRequirement[0], ImmutableList.of()));
    public static final RegistryObject<ShinsuTechnique> MOVE_DEVICES = register("move_devices", () -> new ShinsuTechnique(true, new MoveDevices.Factory(), ShinsuIcons.MOVE, new IRequirement[]{new TypeLevelRequirement(ShinsuTechniqueType.DEVICE_CONTROL, 5)}, ImmutableList.of(Direction.UP, Direction.RIGHT, Direction.LEFT)));
    ...
    public static final RegistryObject<ShinsuTechnique> SCOUT = register("scout", () -> new ShinsuTechnique(false, new Scout.Factory(), ShinsuIcons.EYE, new IRequirement[]{new TypeLevelRequirement(ShinsuTechniqueType.DEVICE_CONTROL, 7)}, ImmutableList.of(Direction.UP, Direction.DOWN, Direction.RIGHT, Direction.LEFT)));
    public static final RegistryObject<ToggleableShinsuTechnique> FOLLOW_OWNER = register("follow_owner", () -> new ToggleableShinsuTechnique(true, new FollowOwner.Factory(), ShinsuIcons.FOLLOW, new IRequirement[]{new TypeLevelRequirement(ShinsuTechniqueType.DEVICE_CONTROL, 1)}, ImmutableList.of(Direction.UP, Direction.LEFT)));
    public static final RegistryObject<ShinsuTechnique> CHANNEL_LIGHTNING = register("channel_lightning", () -> new ShinsuTechnique(true, new ChannelLightning.Factory(), ShinsuIcons.LIGHTNING, new IRequirement[]{new TypeLevelRequirement(ShinsuTechniqueType.CONTROL, 3), new TypeLevelRequirement(ShinsuTechniqueType.MANIFEST, 5), new QualityRequirement(ShinsuQualityRegistry.LIGHTNING.get())}, ImmutableList.of(Direction.DOWN, Direction.UP)));
    ...
    public static final RegistryObject<ShinsuTechnique> BOOST = register("boost", () -> new ShinsuTechnique(false, new Boost.Factory(), ShinsuIcons.SHINSU, new IRequirement[]{new TypeLevelRequirement(ShinsuTechniqueType.CONTROL, 10), new TypeLevelRequirement(ShinsuTechniqueType.MANIFEST, 10), new QualityRequirement(ShinsuQualityRegistry.FIRE.get())}, ImmutableList.of(Direction.UP, Direction.RIGHT, Direction.DOWN, Direction.LEFT)));
    public static final RegistryObject<OverridingShinsuTechnique> FLAMETHROWER = register("flamethrower", () -> new OverridingShinsuTechnique(false, new Flamethrower.Factory(), ShinsuIcons.SHINSU, new IRequirement[]{new TypeLevelRequirement(ShinsuTechniqueType.CONTROL, 3), new TypeLevelRequirement(ShinsuTechniqueType.MANIFEST, 5), new QualityRequirement(ShinsuQualityRegistry.FIRE.get())}, ImmutableList.of(Direction.DOWN, Direction.UP)));
