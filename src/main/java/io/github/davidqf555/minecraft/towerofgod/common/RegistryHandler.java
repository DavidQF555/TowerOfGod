...
public final class RegistryHandler {
    ...
    public static final List<RegistryObject<SpearItem>> SPEAR_ITEMS = ImmutableList.of(WOODEN_SPEAR, STONE_SPEAR, IRON_SPEAR, GOLDEN_SPEAR, DIAMOND_SPEAR, NETHERITE_SPEAR, SUSPENDIUM_SPEAR);
    ...
    public static void registerItems(RegistryEvent.Register<Item> event) {
        event.getRegistry().registerAll(
                ...
                new NeedleItem(ItemTier.WOOD, 1, -1.2f).setRegistryName(WOODEN_NEEDLE.getId()),
                new NeedleItem(ItemTier.STONE, 1, -1.2f).setRegistryName(STONE_NEEDLE.getId()),
                new NeedleItem(ItemTier.IRON, 1, -1.2f).setRegistryName(IRON_NEEDLE.getId()),
                new NeedleItem(ItemTier.GOLD, 1, -1.2f).setRegistryName(GOLDEN_NEEDLE.getId()),
                new NeedleItem(ItemTier.DIAMOND, 1, -1.2f).setRegistryName(DIAMOND_NEEDLE.getId()),
                new NeedleItem(ItemTier.NETHERITE, 1, -1.2f).setRegistryName(NETHERITE_NEEDLE.getId()),
                new NeedleItem(ModToolTier.SUSPENDIUM, 1, 1.6f).setRegistryName(SUSPENDIUM_NEEDLE.getId()),
                new HookItem(ItemTier.WOOD, 3, -3.2f).setRegistryName(WOODEN_HOOK.getId()),
                new HookItem(ItemTier.STONE, 3, -3.2f).setRegistryName(STONE_HOOK.getId()),
                new HookItem(ItemTier.IRON, 3, -3.2f).setRegistryName(IRON_HOOK.getId()),
                new HookItem(ItemTier.GOLD, 3, -3.2f).setRegistryName(GOLDEN_HOOK.getId()),
                new HookItem(ItemTier.DIAMOND, 3, -3.2f).setRegistryName(DIAMOND_HOOK.getId()),
                new HookItem(ItemTier.NETHERITE, 3, -3.2f).setRegistryName(NETHERITE_HOOK.getId()),
                new HookItem(ModToolTier.SUSPENDIUM, 3, -2.4f).setRegistryName(SUSPENDIUM_HOOK.getId()),
                new SpearItem(ItemTier.WOOD, 1, -1.2f).setRegistryName(WOODEN_SPEAR.getId()),
                new SpearItem(ItemTier.STONE, 1, -1.2f).setRegistryName(STONE_SPEAR.getId()),
                new SpearItem(ItemTier.IRON, 1, -1.2f).setRegistryName(IRON_SPEAR.getId()),
                new SpearItem(ItemTier.GOLD, 1, -1.2f).setRegistryName(GOLDEN_SPEAR.getId()),
                new SpearItem(ItemTier.DIAMOND, 1, -1.2f).setRegistryName(DIAMOND_SPEAR.getId()),
                new SpearItem(ItemTier.NETHERITE, 1, -1.2f).setRegistryName(NETHERITE_SPEAR.getId()),
                new SpearItem(ModToolTier.SUSPENDIUM, 1, 1.6f).setRegistryName(SUSPENDIUM_SPEAR.getId()),
    ...
    public static void registerEntityTypes(RegistryEvent.Register<EntityType<?>> event) {
        event.getRegistry().registerAll(
                ...
                EntityType.Builder.create(new SpearEntity.Factory(), EntityClassification.MISC).size(0.5f, 0.5f).build(SPEAR_ENTITY.getId().toString()).setRegistryName(SPEAR_ENTITY.getId())
        );
    }
