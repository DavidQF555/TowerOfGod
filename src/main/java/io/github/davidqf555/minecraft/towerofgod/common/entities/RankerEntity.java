...
public class RankerEntity extends BasicShinsuUserEntity {
    ...
    public RankerEntity(EntityType<? extends RankerEntity> type, Level world) {
        super(type, world);
    ...
    public void registerGoals() {
        ...
        goalSelector.addGoal(2, new CastShinsuGoal<>(this, 20, 50));
    ...
    public int getExperienceReward() {
        return getShinsuLevel() - random.nextInt(3) + 7;
    }
