...
public class MoveDevices extends BasicCommandTechnique {
    ...
    public MoveDevices(LivingEntity user, Vec3 direction, double distance, float speed) {
        super(user);
    ...
    public static class Factory implements ShinsuTechnique.IFactory<MoveDevices> {
        ...
        @Override
        public Either<MoveDevices, Component> create(LivingEntity user, @Nullable Entity target, Vec3 dir) {
        ...
        public MoveDevices blankCreate() {
            return new MoveDevices(null, Vec3.ZERO, 0, 1);
        }
