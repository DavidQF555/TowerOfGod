...
public final class ItemRegistry {
    ...
    public static final RegistryObject<ArmorItem> SUSPENDIUM_HELMET = register("suspendium_helmet", () -> new ArmorItem(ModArmorTier.SUSPENDIUM, EquipmentSlotType.HEAD, new Item.Properties().tab(TowerOfGod.TAB)));
    public static final RegistryObject<ArmorItem> SUSPENDIUM_CHESTPLATE = register("suspendium_chestplate", () -> new ArmorItem(ModArmorTier.SUSPENDIUM, EquipmentSlotType.CHEST, new Item.Properties().tab(TowerOfGod.TAB)));
    public static final RegistryObject<ArmorItem> SUSPENDIUM_LEGGINGS = register("suspendium_leggings", () -> new ArmorItem(ModArmorTier.SUSPENDIUM, EquipmentSlotType.LEGS, new Item.Properties().tab(TowerOfGod.TAB)));
    public static final RegistryObject<ArmorItem> SUSPENDIUM_BOOTS = register("suspendium_boots", () -> new ArmorItem(ModArmorTier.SUSPENDIUM, EquipmentSlotType.FEET, new Item.Properties().tab(TowerOfGod.TAB)));
    public static final RegistryObject<NeedleItem> WOODEN_NEEDLE = register("wooden_needle", () -> new NeedleItem(ItemTier.WOOD, 1, -1.2f, new Item.Properties().tab(TowerOfGod.TAB)));
    public static final RegistryObject<NeedleItem> STONE_NEEDLE = register("stone_needle", () -> new NeedleItem(ItemTier.STONE, 1, -1.2f, new Item.Properties().tab(TowerOfGod.TAB)));
    public static final RegistryObject<NeedleItem> IRON_NEEDLE = register("iron_needle", () -> new NeedleItem(ItemTier.IRON, 1, -1.2f, new Item.Properties().tab(TowerOfGod.TAB)));
    public static final RegistryObject<NeedleItem> GOLDEN_NEEDLE = register("golden_needle", () -> new NeedleItem(ItemTier.GOLD, 1, -1.2f, new Item.Properties().tab(TowerOfGod.TAB)));
    public static final RegistryObject<NeedleItem> DIAMOND_NEEDLE = register("diamond_needle", () -> new NeedleItem(ItemTier.DIAMOND, 1, -1.2f, new Item.Properties().tab(TowerOfGod.TAB)));
    public static final RegistryObject<NeedleItem> NETHERITE_NEEDLE = register("netherite_needle", () -> new NeedleItem(ItemTier.NETHERITE, 1, -1.2f, new Item.Properties().tab(TowerOfGod.TAB)));
    ...
    public static final RegistryObject<HookItem> WOODEN_HOOK = register("wooden_hook", () -> new HookItem(ItemTier.WOOD, 3, -3.2f, new Item.Properties().tab(TowerOfGod.TAB)));
    public static final RegistryObject<HookItem> STONE_HOOK = register("stone_hook", () -> new HookItem(ItemTier.STONE, 3, -3.2f, new Item.Properties().tab(TowerOfGod.TAB)));
    public static final RegistryObject<HookItem> IRON_HOOK = register("iron_hook", () -> new HookItem(ItemTier.IRON, 3, -3.2f, new Item.Properties().tab(TowerOfGod.TAB)));
    public static final RegistryObject<HookItem> GOLDEN_HOOK = register("golden_hook", () -> new HookItem(ItemTier.GOLD, 3, -3.2f, new Item.Properties().tab(TowerOfGod.TAB)));
    ...
    public static final RegistryObject<GuideItem> CONTROL_GUIDE = register("control_guide", () -> new GuideItem(() -> new ShinsuTechnique[]{ShinsuTechniqueRegistry.BODY_REINFORCEMENT.get(), ShinsuTechniqueRegistry.BLACK_FISH.get(), ShinsuTechniqueRegistry.SHINSU_BLAST.get()}, 0xFF7E79DF, new Item.Properties().tab(TowerOfGod.TAB).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<GuideItem> DISRUPTION_GUIDE = register("disruption_guide", () -> new GuideItem(() -> new ShinsuTechnique[]{ShinsuTechniqueRegistry.FLARE_WAVE_EXPLOSION.get(), ShinsuTechniqueRegistry.REVERSE_FLOW_CONTROL.get()}, 0xFF3D3D3D, new Item.Properties().tab(TowerOfGod.TAB).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<GuideItem> MANIFEST_GUIDE = register("manifest_guide", () -> new GuideItem(() -> new ShinsuTechnique[]{ShinsuTechniqueRegistry.MANIFEST.get()}, 0xFF2D3771, new Item.Properties().tab(TowerOfGod.TAB).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<GuideItem> DEVICE_CONTROL_GUIDE = register("device_control_guide", () -> new GuideItem(() -> new ShinsuTechnique[]{ShinsuTechniqueRegistry.MOVE_DEVICES.get(), ShinsuTechniqueRegistry.LIGHTHOUSE_FLOW_CONTROL.get(), ShinsuTechniqueRegistry.SCOUT.get(), ShinsuTechniqueRegistry.FOLLOW_OWNER.get()}, 0xFFD8D8D8, new Item.Properties().tab(TowerOfGod.TAB).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<GuideItem> LIGHTNING_CONTROL_GUIDE = register("lightning_control_guide", () -> new GuideItem(() -> new ShinsuTechnique[]{ShinsuTechniqueRegistry.CHANNEL_LIGHTNING.get()}, 0xFFFFF96D, new Item.Properties().tab(TowerOfGod.TAB).rarity(Rarity.RARE)));
    public static final RegistryObject<GuideItem> FIRE_CONTROL_GUIDE = register("fire_control_guide", () -> new GuideItem(() -> new ShinsuTechnique[]{ShinsuTechniqueRegistry.FLAMETHROWER.get(), ShinsuTechniqueRegistry.BOOST.get()}, 0xFFFF7D13, new Item.Properties().tab(TowerOfGod.TAB).rarity(Rarity.RARE)));
    ...
    public static final RegistryObject<SpearItem> IRON_SPEAR = register("iron_spear", () -> new SpearItem(ItemTier.IRON, 1, -1.2f, new Item.Properties().tab(TowerOfGod.TAB)));
    public static final RegistryObject<SpearItem> GOLDEN_SPEAR = register("golden_spear", () -> new SpearItem(ItemTier.GOLD, 1, -1.2f, new Item.Properties().tab(TowerOfGod.TAB)));
