...
public final class ItemRegistry {
    ...
    public static final RegistryObject<ShinsuShovelItem> SHINSU_SHOVEL = register("shinsu_shovel", null, () -> new ShinsuShovelItem(0.5f, -2, new Item.Properties()));
    public static final RegistryObject<ShinsuPickaxeItem> SHINSU_PICKAXE = register("shinsu_pickaxe", null, () -> new ShinsuPickaxeItem(0, -1.6f, new Item.Properties()));
    public static final RegistryObject<ShinsuAxeItem> SHINSU_AXE = register("shinsu_axe", null, () -> new ShinsuAxeItem(4, -2, new Item.Properties()));
    public static final RegistryObject<ShinsuSwordItem> SHINSU_SWORD = register("shinsu_sword", null, () -> new ShinsuSwordItem(2, -0.8f, new Item.Properties()));
    public static final RegistryObject<ShinsuHoeItem> SHINSU_HOE = register("shinsu_hoe", null, () -> new ShinsuHoeItem(-1, 4, new Item.Properties()));
    public static final RegistryObject<ShinsuBowItem> SHINSU_BOW = register("shinsu_bow", null, () -> new ShinsuBowItem(new Item.Properties()));
    public static final RegistryObject<ShinsuSpearItem> SHINSU_SPEAR = register("shinsu_spear", null, () -> new ShinsuSpearItem(new Item.Properties()));
    public static final RegistryObject<ShinsuHookItem> SHINSU_HOOK = register("shinsu_hook", null, () -> new ShinsuHookItem(3, -3.2f, new Item.Properties()));
    ...
    private static final ResourceKey<CreativeModeTab> TAB = ResourceKey.create(Registries.CREATIVE_MODE_TAB, new ResourceLocation(TowerOfGod.MOD_ID, "main"));
    ...
    public static void onFMLCommonSetup(FMLCommonSetupEvent event) {
        event.enqueueWork(() -> {
            Registry.register(BuiltInRegistries.CREATIVE_MODE_TAB, TAB.location(), CreativeModeTab.builder().icon(() -> SUSPENDIUM.get().getDefaultInstance()).title(Component.translatable(Util.makeDescriptionId("itemGroup", new ResourceLocation(TowerOfGod.MOD_ID, "main")))).build());
        });
    }
    ...
    private static <T extends Item> RegistryObject<T> register(String name, @Nullable ResourceKey<CreativeModeTab> tab, Supplier<T> item) {
