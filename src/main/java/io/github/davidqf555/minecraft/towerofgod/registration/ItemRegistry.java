...
public final class ItemRegistry {
    ...
    public static final RegistryObject<GuideItem> FIRE_CONTROL_GUIDE = register("fire_control_guide", () -> new GuideItem(() -> new ShinsuTechnique[]{ShinsuTechniqueRegistry.FLAMETHROWER.get(), ShinsuTechniqueRegistry.BOOST.get()}, new TranslationTextComponent("item." + TowerOfGod.MOD_ID + ".fire_control_guide.author"), 0xFFFF7D13));
