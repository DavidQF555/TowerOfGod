...
public final class ItemRegistry {
    ...
    public static final RegistryObject<ShinsuHookItem> SHINSU_HOOK = register("shinsu_hook", () -> new ShinsuHookItem(3, -3.2f));
    ...
    public static final RegistryObject<ShinsuShovelItem> SHINSU_SHOVEL = register("shinsu_shovel", () -> new ShinsuShovelItem(0.5f, -2));
    public static final RegistryObject<ShinsuPickaxeItem> SHINSU_PICKAXE = register("shinsu_pickaxe", () -> new ShinsuPickaxeItem(0, -1.6f));
    public static final RegistryObject<ShinsuAxeItem> SHINSU_AXE = register("shinsu_axe", () -> new ShinsuAxeItem(4, -2));
    public static final RegistryObject<ShinsuSwordItem> SHINSU_SWORD = register("shinsu_sword", () -> new ShinsuSwordItem(2, -0.8f));
    public static final RegistryObject<ShinsuHoeItem> SHINSU_HOE = register("shinsu_hoe", () -> new ShinsuHoeItem(-1, 4));
    public static final RegistryObject<ShinsuBowItem> SHINSU_BOW = register("shinsu_bow", ShinsuBowItem::new);
    public static final RegistryObject<ShinsuSpearItem> SHINSU_SPEAR = register("shinsu_spear", ShinsuSpearItem::new);
