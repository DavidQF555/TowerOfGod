...
public final class ItemRegistry {
    ...
    public static final RegistryObject<ArmorItem> SUSPENDIUM_HELMET = register("suspendium_helmet", ItemRegistry::getTab, () -> new ArmorItem(ModArmorTier.SUSPENDIUM, EquipmentSlot.HEAD, new Item.Properties()));
    public static final RegistryObject<ArmorItem> SUSPENDIUM_CHESTPLATE = register("suspendium_chestplate", ItemRegistry::getTab, () -> new ArmorItem(ModArmorTier.SUSPENDIUM, EquipmentSlot.CHEST, new Item.Properties()));
    public static final RegistryObject<ArmorItem> SUSPENDIUM_LEGGINGS = register("suspendium_leggings", ItemRegistry::getTab, () -> new ArmorItem(ModArmorTier.SUSPENDIUM, EquipmentSlot.LEGS, new Item.Properties()));
    public static final RegistryObject<ArmorItem> SUSPENDIUM_BOOTS = register("suspendium_boots", ItemRegistry::getTab, () -> new ArmorItem(ModArmorTier.SUSPENDIUM, EquipmentSlot.FEET, new Item.Properties()));
